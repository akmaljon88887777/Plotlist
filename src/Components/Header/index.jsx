    ...
    <div className="flex flex-col w-full justify-center items-center z-1">
      <div className="md:-mt-[650px] -mt-[500px] lg:mt-0">
        ...
        <div className="flex  justify-center">
          <div className="w-[85%] lg:h-[70px] h-[400px] rounded bg-[#fff] absolute lg:grid lg:grid-cols-4 grid-cols-1 md:grid grid lg:flex-row justify-items-center items-center">
            ...
            <button
              ...
              type="submit"
            >
              <i class="fa fa-search w-10 h-10 rounded-full bg-[#FFFFFF] text-[#8d99af] flex items-center justify-center"></i>
              Search Now
            </button>
          </div>
        </div>
